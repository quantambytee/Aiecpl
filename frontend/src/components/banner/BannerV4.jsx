...
const BannerV4 = () => {
    ...
    return (
        <>
            <section className="hero-section-three bgs-cover overlay pt-160 rpt-140 pb-80 rpb-100" style={{ backgroundImage: "url(/images/hero/hero-four.jpg)" }}>
                            ...
                            <div className="hero-content text-white rmb-65">
                                ...
                                <Fade bottom delay={800}>
                                    <div className="hero-btns mt-35">
                                        ...
                                        <Link to="/about#" className="theme-btn style-five mb-10">learn more</Link>
                                    </div>
                                </Fade>
                            </div>
                        </div>
                        <div className="col-lg-5">
                            <Fade right delay={500}>
                                <div className="hero-section-form bg-white p-50">
                                    ...
                                    <form className="hero-form mt-20" name="hero-form" onSubmit={handleForm} >
                                        <div className="form-group">
                                            <label htmlFor="name">Your Full Name</label>
                                            <input type="text" id="name" name="name" className="form-control" placeholder="Timothy K. Lukas" autoComplete='off' required />
                                        </div>
                                        <div className="form-group">
                                            <label htmlFor="email">Email address</label>
                                            <input type="email" id="email" name="email" className="form-control" placeholder="support@gmail.com" autoComplete='off' required />
                                        </div>
                                        <div className="form-group">
