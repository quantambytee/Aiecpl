                        ...
                        <div className="row">
                            ...
                            <div className="col-lg-5">
                                <Fade className="fadeInRight" delay={300}>
                                    <div className="contact-image-number bgs-cover" style={{ backgroundImage: `url(${contactUs})` }}>
                                        <div className="contact-number getInTouch">
                                            <i className="fas fa-phone-alt"></i>
                                            <a href="tel:+012-345-6789">+91 -8789701805</a>
                                        </div>
                                    </div>
                                </Fade>
                            </div>
